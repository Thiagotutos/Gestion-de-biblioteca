...
$stmt = $pdo->query("SELECT * FROM racks ORDER BY name ASC");
$racks = $stmt->fetchAll();
?>
...
<div style="display: flex; gap: 20px;">
    ...
    <div style="flex: 2;">
        <table class="data-table">
            ...
            <tbody>
                <?php foreach ($racks as $cat): ?>
                <tr>
                    <td><?php echo $cat['id']; ?></td>
                    <td><?php echo htmlspecialchars($cat['name']); ?></td>
                    <?php if ($_SESSION['user_role'] !== 'Lector'): ?>
                    <td>
                        <a href="racks.php?delete=<?php echo $cat['id']; ?>" class="btn btn-delete" onclick="return confirm('Â¿Borrar categorÃ­a?');">Borrar</a>
                    </td>
                    <?php else: ?>
                    <td>-</td>
                    <?php endif; ?>
